...
describe('GET /companies', function() {
	...
	test('gets company with a max num employee', async function() {
	...
	test('gets company with a min num employee', async function() {
	...
	test('gets company in between filter parameter', async function() {
